local c = require("marine-dark.palette")
...
theme.set_highlights = function()
	...
	hl(0, "CursorLineNr", { fg = c.light_grey_3, bg = "NONE" })
	...
	hl(0, "ErrorMsg", { fg = c.red, bg = c.bg })
	...
	hl(0, "FloatBorder", { fg = c.green, bg = c.bg })
	...
	-- NvimTree
	hl(0, "NvimTreeNormal", { fg = c.cyan, bg = c.alt_bg })
	...
	hl(0, "@keyword.import.tsx", { fg = c.cyan, bg = "NONE" })
	...
	-- Rust
	hl(0, "rustEnumVariant", { fg = c.blue, bg = "NONE" })
